...
base_model_VGG19 = VGG19(include_top=False, weights='imagenet', input_shape=(ScaleTo, ScaleTo, 3), classes=clearTrainLabel.shape[1])
...
model_vgg19.add(Dense(num_clases,activation=('softmax')))
...
# checkpoints
filepath="/home/ec2-user/Keras_Ex/NN/Assignment_CNN_Group/Saved_Models/Saved/VGG19/weights.best_{epoch:02d}-{val_accuracy:.2f}.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='val_accuracy',verbose=1, save_best_only=True, mode='max')

filepath="/home/ec2-user/Keras_Ex/NN/Assignment_CNN_Group/Saved_Models/Saved/VGG19/weights.last_auto4.hdf5"
...
# fit model
#hist = model_vgg19.fit_generator(datagen.flow(trainX, trainY, batch_size=10), 
...
model_vgg19.load_weights("/home/ec2-user/Keras_Ex/NN/Assignment_CNN_Group/Saved_Models/Saved/VGG19/weights.best_34-0.93.hdf5")
...
a_logger.debug(model_vgg19.evaluate(trainX, trainY))  # Evaluate on train set
a_logger.debug(model_vgg19.evaluate(testX, testY))  # Evaluate on test set
...
predY = model_vgg19.predict(testX)
...
pred = model_vgg19.predict(clearTestImg)
...
#res.to_csv("/home/ec2-user/Keras_Ex/NN/Assignment_CNN_Group/Saved_Models/Saved/VGG19/res.csv", index=False)
