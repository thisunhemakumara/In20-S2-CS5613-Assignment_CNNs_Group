...
# checkpoints
filepath="/home/ec2-user/Keras_Ex/NN/Assignment_CNN_Group/Saved_Models/Saved/Original/weights.best_{epoch:02d}-{val_accuracy:.2f}.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='val_accuracy',verbose=1, save_best_only=True, mode='max')

filepath="/home/ec2-user/Keras_Ex/NN/Assignment_CNN_Group/Saved_Models/Saved/Original/weights.last_auto4.hdf5"
...
# fit model
#hist = model.fit_generator(datagen.flow(trainX, trainY, batch_size=10), 
...
model.load_weights("/home/ec2-user/Keras_Ex/NN/Assignment_CNN_Group/Saved_Models/Saved/Original/weights.best_32-0.92.hdf5")
...
a_logger.debug(model.evaluate(trainX, trainY))  # Evaluate on train set
a_logger.debug(model.evaluate(testX, testY))  # Evaluate on test set
...
#res.to_csv("/home/ec2-user/Keras_Ex/NN/Assignment_CNN_Group/Saved_Models/Saved/Original/res.csv", index=False)
